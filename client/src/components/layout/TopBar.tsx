        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="bg-primary-50 border border-primary-300 text-primary-600 rounded-full py-2 pl-10 pr-4 text-sm w-64
          ...
          <div className="relative">
            <button className="p-2 rounded-lg text-primary-500 text-white">
